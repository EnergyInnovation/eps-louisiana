...
PotentialPolicies = (
    ...
    (True, "Perc Subsidy for Elec Capacity Construction[offshore wind es]","Perc Subsidy for Elec Capacity Construction[offshore wind es]",[0,0.3],"Electricity PTC/ITC"),
    ...
    (True, "Percent Reduction in Nonenergy Nonagriculture Industry Product Demand[cement and other nonmetallic minerals 239]","Percent Reduction in Nonenergy Nonagriculture Industry Product Demand[cement and other nonmetallic minerals 239]",[0,0.1],"Reduction in Industry Product Demand"),
